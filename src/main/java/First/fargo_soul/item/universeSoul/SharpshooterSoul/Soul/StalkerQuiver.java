...
/*
	public static void StalkerQuiverTickHandler(PlayerTickEvent.Post event) {
		if (event.getEntity() instanceof ServerPlayer player) {
			DeferredItem<SoulItem> StalkerQuiver = ItemRegister.StalkerQuiver;
	...
	public static void StalkerQuiverTargetChangeHandler(LivingChangeTargetEvent event) {
		if (event.getNewAboutToBeSetTarget() instanceof ServerPlayer player && CurioUtils.isEquipped(player, ItemRegister.StalkerQuiver.get())) {
