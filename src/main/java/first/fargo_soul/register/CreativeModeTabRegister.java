...
public class CreativeModeTabRegister {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> FargoSoulTab =
            Register.register(FargoSoul.MODID, () -> {
                ...
                builder.icon(() -> FargoSoulItemRegister.TerraSoulItem.get().getDefaultInstance());
                builder.displayItems((parameters, output) -> {
                    output.accept(FargoSoulItemRegister.CosmicCrucibleBlockItem);
                    output.accept(FargoSoulItemRegister.Soul);
