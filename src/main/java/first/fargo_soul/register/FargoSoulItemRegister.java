...
public class FargoSoulItemRegister {
    ...
    public static final DeferredItem<TerraSoul> TerraSoulItem =
            register("terra_soul", TerraSoul::new, LyraRarity.Rainbow)
                    ...
                    .itemLanguageTooltip(1, "The ultimate soul uniting all nine forces, granting every ability below:", "综合九系之力的至强魂石，汇聚以下全部力量：")
                    .itemLanguageTooltip(2, "Cosmic Force: absorb cosmic energy each second; up to +80% damage dealt and -20% damage taken, bursting into a supernova on death", "宇宙之力：每秒汲取宇宙能量，至多+80%造成伤害、-20%受到伤害，死亡时引发超新星爆发")
                    .itemLanguageTooltip(3, "Death Force: shadow dash applies Death Mark (-20% max HP, -40% armor, -10% speed) and deals +200% damage to marked targets", "死亡之力：暗影冲刺施加死亡标记（-20%最大生命、-40%护甲、-10%移速），对被标记目标+200%伤害")
                    .itemLanguageTooltip(4, "Terra Force: launch thunder orbs that shock and poison, gaining Terra Resonance for +100% damage", "泰拉之力：释放雷电球电击并施加铅中毒，触发泰拉共鸣时伤害+100%")
                    .itemLanguageTooltip(5, "Forest Force: a 12-block aura of decay and bleeding, tracking blood orbs heal you, and picking up items grants boosted crits", "森林之力：12格凋零与流血光环，追踪鲜血球为你回血，拾取物品获暴击增益")
                    .itemLanguageTooltip(6, "Earth Force: gather earth energy for up to +100% damage, +100% attack speed, +5 health regen and +100% armor", "大地之力：积聚大地能量，至多+100%造成伤害、+100%攻速、+5每秒生命恢复、+100%护甲")
                    .itemLanguageTooltip(7, "Nature Force: 5 orbiting chlorophyte crystals fire lasers and reduce damage taken by 15", "自然之力：5颗叶绿水晶环绕发射激光，受到伤害-15")
                    .itemLanguageTooltip(8, "Life Force: grants flight with +150% duration, honey triggers Ambrosia, and reflects 500% of damage", "生命之力：获得飞行（时长+150%），蜂蜜触发仙馔密酒，反弹500%伤害")
                    .itemLanguageTooltip(9, "Spirit Force: +70% healing received, +100% flight time, and 8 extra Blades of Sorrows dealing +200% damage", "心灵之力：受到治疗+70%，飞行时间+100%，额外8柄胜利与誓约之刃且伤害+200%")
                    .itemLanguageTooltip(10, "Will Force: +25% healing received, a 40% chance of 1600% extra loot on kills, and +80% damage to Midas targets", "意志之力：受到治疗+25%，击杀40%概率爆出1600%额外战利品，对迈达斯目标伤害+80%")
