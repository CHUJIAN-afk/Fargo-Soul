...
public class FargoSoulItemRegister {
    ...
    public static final DeferredItem<TerraSoul> TerraSoulItem =
            register("terra_soul", TerraSoul::new, LyraRarity.Rainbow)
                    ...
                    .itemLanguageTooltip(1, "The ultimate soul uniting all nine forces and every sub-soul beneath them:", "综合九系之力的至强魂石，完整汇聚以下所有力量及其麾下魂石的全部效果：")
                    .itemLanguageTooltip(2, "Cosmic Force - Absorb 1 Cosmic Energy per second (max 100); damage dealt up to +80% and damage taken up to -20% based on stored energy; taking damage over 50% of your max HP spends 50 energy to cut it by 50%; on death, erupt in a supernova dealing 3600% of your max HP as magic damage. Combines Blaze, Meteor, Wizard, Stardust, Nebula and Vortex souls.", "宇宙之力 - 每秒汲取1点宇宙能量（最多100点），随能量积累造成伤害最高+80%、受到伤害最高-20%；受到超过最大生命值50%的伤害时消耗50能量使其减半；死亡时引发超新星爆炸，造成你最大生命值3600%的魔法伤害。聚合烈焰、流星、法师、星尘、星云、涡流之魂。")
                    .itemLanguageTooltip(3, "Death Force - Grants the Shadow Dash (+50% initial speed); dashing through foes applies Death Mark for 10s (-20% max HP, -40% armor, -10% speed); +200% damage to marked foes; bonus damage equal to up to 25% of missing health against foes below 12% max HP; immune to Death Mark. Combines Ancient Shadow, Crystal Assassin, Dark Artist, Gloomy, Necromancer, Ninja and Penetrating Ninja souls.", "死亡之力 - 赋予暗影冲刺（初速+50%）；冲刺穿过敌人施加10秒死亡标记（-20%最大生命值、-40%护甲、-10%移速）；对被标记敌人+200%伤害；对低于12%最大生命值的敌人额外造成至多相当于其25%已损生命值的伤害；免疫死亡标记。聚合远古暗影、水晶刺客、暗之艺术家、阴郁、死灵法师、忍者、渗透忍者之魂。")
                    .itemLanguageTooltip(4, "Terra Force - 20% chance on attack to release 3-6 thunder orbs that shock and poison nearby foes (1s cooldown); more active orbs raise the chance and shorten the cooldown (up to +40% chance, -60% cooldown); 5% chance for +100% damage and 5s of Terra Resonance (+20% orb chance, +80% orb damage); damage taken reduced by [4 + 2% of your max HP]. Combines Copper, Iron, Lead, Obsidian, Silver, Tin and Tungsten souls.", "泰拉之力 - 攻击时20%概率释放3~6颗雷电球，电击并铅中毒附近的敌人（1秒冷却）；场上雷电球越多释放概率越高、冷却越短（至多+40%概率、-60%冷却）；5%概率使伤害+100%并获得5秒泰拉共鸣（雷电球概率+20%、伤害+80%）；受到的伤害减少[4+你2%最大生命值]。聚合铜、铁、铅、黑曜石、银、锡、钨之魂。")
                    .itemLanguageTooltip(5, "Forest Force - A 12-block aura applies 8s of Wither and Bleeding each second; +8 damage to Wither-affected foes; attacking Bleeding foes makes them burst into 3-6 tracking blood orbs (3 HP each, their healing -50%); snowballs from above apply Chill (-30% speed, 2s cooldown); picking up items grants +40% critical damage for 8s; trading prices -50%. Combines Wood, Pine, Rosewood, Ebony, Shadowwood, Palm and Pearlwood souls.", "森林之力 - 12格光环每秒施加8秒凋零与流血；对凋零目标+8伤害；攻击流血目标使其喷出3~6颗追踪血球（每颗回血3点，受流血者治疗-50%）；头顶雪球施加寒冷（-30%移速，2秒冷却）；拾取物品后8秒内暴击伤害+40%；交易价格-50%。聚合木头、松木、玫瑰木、乌木、影木、棕榈木、珍珠木之魂。")
                    .itemLanguageTooltip(6, "Earth Force - After 3s without attacking, build 20 Earth Energy per second (max 1000; attacks spend 10); based on stored energy, up to +100% damage, +100% attack speed, +5 HP/s regen and +100% armor. Combines Cobalt, Palladium, Mithril, Orichalcum, Adamantite and Titanium souls.", "大地之力 - 3秒未攻击后每秒积聚20点大地能量（最多1000点，攻击消耗10点）；按能量比例至多+100%造成伤害、+100%攻速、+5每秒生命恢复、+100%护甲。聚合钴、钯金、秘银、山铜、精金、钛之魂。")
                    .itemLanguageTooltip(7, "Nature Force - Summons 5 orbiting chlorophyte crystals that fire lasers at foes (+300% crystal damage); damage taken reduced by 15. Combines Crimson, Lava, Rain Cloud, Frost, Green and Mushroom souls.", "自然之力 - 召唤5颗环绕的叶绿水晶向敌人发射激光（水晶伤害+300%）；受到的伤害-15。聚合绯红、熔岩、雨云、霜冻、翠绿、蘑菇之魂。")
                    .itemLanguageTooltip(8, "Life Force - Grants flight (+150% flight time); drinking honey grants 10s of Ambrosia (+30% damage, +5 HP/s regen, +200% summon damage); reflects 500% of damage taken (0.1s cooldown). Combines Bee, Beetle, Pumpkin, Spider and Turtle souls.", "生命之力 - 赋予飞行（飞行时间+150%）；饮蜂蜜获得10秒仙馔密酒（伤害+30%、+5每秒生命恢复、召唤伤害+200%）；反弹500%受到的伤害（0.1秒冷却）。聚合蜜蜂、甲虫、南瓜、蜘蛛、乌龟之魂。")
                    .itemLanguageTooltip(9, "Spirit Force - Healing received +70%; flight time +100%; summons 8 extra Blades of Sorrows with +200% damage. Combines Forbidden, Holy, Ancient Holy, Teke and Ghost souls.", "心灵之力 - 受到的治疗+70%；飞行时间+100%；额外召唤8柄胜利与誓约之刃（伤害+200%）。聚合禁戒、神圣、远古神圣、泰克、幽灵之魂。")
                    .itemLanguageTooltip(10, "Will Force - Healing received +25%; killing foes has a 40% chance to multiply loot by 1600%; +80% damage to Midas-affected foes. Combines Gold, Platinum, Gladiator, Red Riding and Valhalla Knight souls.", "意志之力 - 受到的治疗+25%；击杀敌人有40%概率使战利品量×1600%；对受迈达斯影响的敌人+80%伤害。聚合黄金、铂金、角斗士、小红帽、瓦尔哈拉骑士之魂。")
                    .itemLanguageTooltip(-1, "“Terra Sovereign, witnessed by heaven and earth”", "“泰拉之主，天地共证”")
