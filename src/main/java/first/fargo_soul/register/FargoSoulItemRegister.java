...
public class FargoSoulItemRegister {
    ...
    public static final DeferredItem<Item> Soul = FargoSoulItemRegisterBuilder.build("soul")
    ...
    public static final DeferredItem<BlockItem> CosmicCrucibleBlockItem = FargoSoulItemRegisterBuilder.build("cosmic_crucible", () -> new BlockItem(BlockRegister.CosmicCrucible.get(), new Item.Properties().stacksTo(1)))
            .itemLanguage("Cosmic Crucible", "宇宙坩埚")
