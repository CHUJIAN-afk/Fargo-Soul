...
public class FargoSoulSoulItemRegister {
    ...
    public static final DeferredItem<MeteorSoul> CosmicCrucibleBlockItem = FargoSoulItemRegisterBuilder.build("blaze_soul", MeteorSoul::new)
            .itemLanguage("Meteor Soul", "流星魔石")
            .itemLanguageTooltip(1, " ", "按下潜行键大幅增加下落速度")
            .itemLanguageTooltip(2, " ", "增加15%移动速度")
