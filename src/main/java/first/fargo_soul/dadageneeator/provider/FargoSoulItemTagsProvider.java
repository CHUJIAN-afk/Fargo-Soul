...
public class FargoSoulItemTagsProvider extends ItemTagsProvider {

    public static final Map<TagKey<Item>, List<ItemLike>> ItemTagsGenerate = new HashMap<>();

    public FargoSoulItemTagsProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagLookup<Block>> blockTags, ExistingFileHelper existingFileHelper) {
        super(packOutput, lookupProvider, blockTags, FargoSoul.MODID, existingFileHelper);
    }
